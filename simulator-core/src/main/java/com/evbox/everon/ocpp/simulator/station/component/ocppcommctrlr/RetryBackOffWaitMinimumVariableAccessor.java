...
public class RetryBackOffWaitMinimumVariableAccessor extends VariableAccessor {
    public static final String NAME = "RetryBackOffWaitMinimum";
    public static final String RETRY_BACK_OFF_WAIT_MIN = "12";
    ...
    public RetryBackOffWaitMinimumVariableAccessor(Station station, StationStore stationStore) {
    ...
    public List<ReportData> generateReportData(String componentName) {
        ...
        VariableAttribute variableAttribute = new VariableAttribute()
                .withValue(new CiString.CiString2500(RETRY_BACK_OFF_WAIT_MIN))
                .withPersistent(true)
    ...
    private GetVariableResult getActualValue(AttributePath attributePath) {
        return new GetVariableResult()
                ...
                .withAttributeValue(new CiString.CiString2500(RETRY_BACK_OFF_WAIT_MIN));
    }
}
