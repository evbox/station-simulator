...
public class RetryBackOffRandomRangeVariableAccessor extends VariableAccessor {
    public static final String NAME = "RetryBackOffRandomRange";
    public static final String RETRY_BACK_OFF_RANDOM_RANGE = "10";
    ...
    private final Map<AttributeType, SetVariableValidator> variableValidators = ImmutableMap.<AttributeType, SetVariableValidator>builder()
            ...
            .build();
    public RetryBackOffRandomRangeVariableAccessor(Station station, StationStore stationStore) {
    ...
    public List<ReportData> generateReportData(String componentName) {
        VariableCharacteristics variableCharacteristics = new VariableCharacteristics()
                ...
                .withMinLimit(new BigDecimal(0))
                .withMaxLimit(new BigDecimal(86400))
                .withSupportsMonitoring(false);
        VariableAttribute variableAttribute = new VariableAttribute()
                .withValue(new CiString.CiString2500(RETRY_BACK_OFF_RANDOM_RANGE))
                .withPersistent(true)
    ...
    private GetVariableResult getActualValue(AttributePath attributePath) {
        return new GetVariableResult()
                ...
                .withAttributeValue(new CiString.CiString2500(RETRY_BACK_OFF_RANDOM_RANGE));
    }
}
