...
public class UnlockOnEVSideDisconnectVariableAccessor extends VariableAccessor {
    public static final String NAME = "UnlockOnEVSideDisconnect";
    public static final String SHOULD_UNLOCK_ON_EVSE_DISCONNECT = "true";
    ...
    public UnlockOnEVSideDisconnectVariableAccessor(Station station, StationStore stationStore) {
    ...
    public List<ReportData> generateReportData(String componentName) {
        ...
        VariableAttribute variableAttribute = new VariableAttribute()
                .withValue(new CiString.CiString2500(SHOULD_UNLOCK_ON_EVSE_DISCONNECT))
                .withPersistent(true)
    ...
    private GetVariableResult getActualValue(AttributePath attributePath) {
        return new GetVariableResult()
                ...
                .withAttributeValue(new CiString.CiString2500(SHOULD_UNLOCK_ON_EVSE_DISCONNECT));
    }
}
