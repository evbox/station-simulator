...
public class HeartbeatIntervalVariableAccessor extends VariableAccessor {
    ...
    public HeartbeatIntervalVariableAccessor(Station station, StationPersistenceLayer stationPersistenceLayer) {
    ...
    public List<ReportDatum> generateReportData(String componentName) {
        ...
        int heartbeatInterval = getStationPersistenceLayer().getHeartbeatInterval();
