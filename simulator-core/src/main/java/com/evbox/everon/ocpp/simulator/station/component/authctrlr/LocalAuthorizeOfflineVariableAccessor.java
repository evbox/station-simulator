...
public class LocalAuthorizeOfflineVariableAccessor extends VariableAccessor {
    public static final String NAME = "LocalAuthorizeOffline";
    public static final String LOCAL_AUTH_OFFLINE_ENABLED = "true";
    ...
    private final Map<AttributeType, SetVariableValidator> variableValidators = ImmutableMap.<AttributeType, SetVariableValidator>builder()
            ...
            .build();
    public LocalAuthorizeOfflineVariableAccessor(Station station, StationStore stationStore) {
    ...
    public List<ReportData> generateReportData(String componentName) {
        ...
        VariableAttribute variableAttribute = new VariableAttribute()
                .withValue(new CiString.CiString2500(LOCAL_AUTH_OFFLINE_ENABLED))
                .withPersistent(true)
    ...
    private GetVariableResult getActualValue(AttributePath attributePath) {
        return new GetVariableResult()
                ...
                .withAttributeValue(new CiString.CiString2500(LOCAL_AUTH_OFFLINE_ENABLED));
    }
}
