...
public class AvailabilityStateVariableAccessor extends VariableAccessor {
    ...
    public AvailabilityStateVariableAccessor(Station station, StationPersistenceLayer stationPersistenceLayer) {
    ...
    private GetVariableResult getActualValue(AttributePath attributePath) {
        ...
        boolean evseExists = getStationPersistenceLayer().hasEvse(evseId);
