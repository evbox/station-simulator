...
public class EntriesVariableAccessor extends VariableAccessor {

    public static final String NAME = "Entries";
    public static final String LOCAL_AUTH_ENTRIES = "0";
    ...
    public EntriesVariableAccessor(Station station, StationStore stationStore) {
    ...
    public List<ReportData> generateReportData(String componentName) {
        ...
        VariableAttribute variableAttribute = new VariableAttribute()
                .withValue(new CiString.CiString2500(LOCAL_AUTH_ENTRIES))
    ...
    private GetVariableResult getActualValue(AttributePath attributePath) {
        return new GetVariableResult()
                ...
                .withAttributeValue(new CiString.CiString2500(LOCAL_AUTH_ENTRIES));
    }
}
