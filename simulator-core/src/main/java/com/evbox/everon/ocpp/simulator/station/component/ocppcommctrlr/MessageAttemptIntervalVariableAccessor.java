...
public class MessageAttemptIntervalVariableAccessor extends VariableAccessor {
    public static final String NAME = "MessageAttemptInterval";
    public static final String MESSAGE_ATTEMPT_INTERVAL = "3";
    ...
    public MessageAttemptIntervalVariableAccessor(Station station, StationStore stationStore) {
    ...
    public List<ReportData> generateReportData(String componentName) {
        ...
        VariableAttribute variableAttribute = new VariableAttribute()
                .withValue(new CiString.CiString2500(MESSAGE_ATTEMPT_INTERVAL))
                .withPersistent(true)
    ...
    private GetVariableResult getActualValue(AttributePath attributePath) {
        return new GetVariableResult()
                ...
                .withAttributeValue(new CiString.CiString2500(MESSAGE_ATTEMPT_INTERVAL));
    }
}
