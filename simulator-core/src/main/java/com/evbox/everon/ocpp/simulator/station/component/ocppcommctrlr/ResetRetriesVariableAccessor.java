...
public class ResetRetriesVariableAccessor extends VariableAccessor {
    public static final String NAME = "ResetRetries";
    public static final String RESET_RETRIES_NUMBER = "3";
    ...
    public ResetRetriesVariableAccessor(Station station, StationStore stationStore) {
    ...
    public List<ReportData> generateReportData(String componentName) {
        VariableCharacteristics variableCharacteristics = new VariableCharacteristics()
                ...
                .withMaxLimit(new BigDecimal(10))
                .withSupportsMonitoring(false);
        VariableAttribute variableAttribute = new VariableAttribute()
                .withValue(new CiString.CiString2500(RESET_RETRIES_NUMBER))
                .withPersistent(true)
    ...
    private GetVariableResult getActualValue(AttributePath attributePath) {
        return new GetVariableResult()
                ...
                .withAttributeValue(new CiString.CiString2500(RESET_RETRIES_NUMBER));
    }
}
