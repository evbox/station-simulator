...
public class StopTxOnEVSideDisconnectVariableAccessor extends VariableAccessor {
    ...
    public List<ReportData> generateReportData(String componentName) {
        ...
        VariableAttribute variableAttribute = new VariableAttribute()
                .withValue(new CiString.CiString2500(SHOULD_STOP_TRANS_ON_EV_DISCONNECT))
                .withPersistent(true)
    ...
    private GetVariableResult getActualValue(AttributePath attributePath) {
        return new GetVariableResult()
                ...
                .withAttributeValue(new CiString.CiString2500(SHOULD_STOP_TRANS_ON_EV_DISCONNECT));
    }
}
