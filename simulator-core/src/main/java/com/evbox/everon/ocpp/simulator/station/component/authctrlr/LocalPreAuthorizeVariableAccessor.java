...
public class LocalPreAuthorizeVariableAccessor extends VariableAccessor {
    public static final String NAME = "LocalPreAuthorize";
    public static final String LOCAL_PRE_AUTH_ENABLED = "true";
    ...
    public LocalPreAuthorizeVariableAccessor(Station station, StationStore stationStore) {
    ...
    public List<ReportData> generateReportData(String componentName) {
        ...
        VariableAttribute variableAttribute = new VariableAttribute()
                .withValue(new CiString.CiString2500(LOCAL_PRE_AUTH_ENABLED))
                .withPersistent(true)
    ...
    private GetVariableResult getActualValue(AttributePath attributePath) {
        return new GetVariableResult()
                ...
                .withAttributeValue(new CiString.CiString2500(LOCAL_PRE_AUTH_ENABLED));
    }
}
