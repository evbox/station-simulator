...
public class TimeSourceVariableAccessor extends VariableAccessor {
    public static final String NAME = "TimeSource";
    public static final String CLOCK_TIME_SOURCE = "NTP,MobileNetwork";
    ...
    private final Map<AttributeType, SetVariableValidator> variableValidators = ImmutableMap.<AttributeType, SetVariableValidator>builder()
            ...
            .build();
    public TimeSourceVariableAccessor(Station station, StationStore stationStore) {
    ...
    public List<ReportData> generateReportData(String componentName) {
        ...
        VariableAttribute variableAttribute = new VariableAttribute()
                .withValue(new CiString.CiString2500(CLOCK_TIME_SOURCE))
    ...
    private GetVariableResult getActualValue(AttributePath attributePath) {
        return new GetVariableResult()
                ...
                .withAttributeValue(new CiString.CiString2500(CLOCK_TIME_SOURCE));
    }
}
