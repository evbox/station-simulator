...
public class SerialNumberVariableAccessor extends VariableAccessor {
    ...
    public List<ReportData> generateReportData(String componentName) {
        ...
        VariableAttribute variableAttribute = new VariableAttribute()
                .withValue(new CiString.CiString2500(getStationStore().getStationSerialNumber()))
                .withPersistent(true)
                .withConstant(true)
    ...
    private GetVariableResult getActualValue(AttributePath attributePath) {
        return new GetVariableResult()
                ...
                .withAttributeValue(new CiString.CiString2500(getStationStore().getStationSerialNumber()))
