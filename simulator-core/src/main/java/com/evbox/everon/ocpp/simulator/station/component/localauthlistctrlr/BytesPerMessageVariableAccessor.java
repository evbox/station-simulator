...
public class BytesPerMessageVariableAccessor extends VariableAccessor {
    public static final String NAME = "BytesPerMessage";
    public static final String LOCAL_AUTH_BYTES_PER_MESSAGE = "2000";
    ...
    public BytesPerMessageVariableAccessor(Station station, StationStore stationStore) {
    ...
    public List<ReportData> generateReportData(String componentName) {
        VariableCharacteristics variableCharacteristics = new VariableCharacteristics()
                ...
                .withMaxLimit(new BigDecimal(2000))
                .withSupportsMonitoring(false);
        VariableAttribute variableAttribute = new VariableAttribute()
                .withValue(new CiString.CiString2500(LOCAL_AUTH_BYTES_PER_MESSAGE))
    ...
    private GetVariableResult getActualValue(AttributePath attributePath) {
        return new GetVariableResult()
                ...
                .withAttributeValue(new CiString.CiString2500(LOCAL_AUTH_BYTES_PER_MESSAGE));
    }
}
