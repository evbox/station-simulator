...
public class EnabledVariableAccessor extends VariableAccessor {
    ...
    public static final String LOCAL_AUTH_ENABLED_STATUS = "false";
    ...
    public List<ReportData> generateReportData(String componentName) {
        ...
        VariableAttribute variableAttribute = new VariableAttribute()
                .withValue(new CiString.CiString2500(LOCAL_AUTH_ENABLED_STATUS))
                .withPersistent(true)
    ...
    private GetVariableResult getActualValue(AttributePath attributePath) {
        return new GetVariableResult()
                ...
                .withAttributeValue(new CiString.CiString2500(LOCAL_AUTH_ENABLED_STATUS));
    }
}
