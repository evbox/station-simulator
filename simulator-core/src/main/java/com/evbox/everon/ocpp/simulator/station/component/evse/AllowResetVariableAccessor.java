...
public class AllowResetVariableAccessor extends VariableAccessor {
    public static final String NAME = "AllowReset";
    public static final String EVSE_ALLOW_RESET_ENABLED_STATUS = "false";
    ...
    public AllowResetVariableAccessor(Station station, StationStore stationStore) {
    ...
    public List<ReportData> generateReportData(String componentName) {
        ...
        VariableAttribute variableAttribute = new VariableAttribute()
                .withValue(new CiString.CiString2500(EVSE_ALLOW_RESET_ENABLED_STATUS))
    ...
    private GetVariableResult getActualValue(AttributePath attributePath) {
        return new GetVariableResult()
                ...
                .withAttributeValue(new CiString.CiString2500(EVSE_ALLOW_RESET_ENABLED_STATUS));
    }
}
