...
public class VendorNameVariableAccessor extends VariableAccessor {
    public static final String NAME = "VendorName";
    public static final String STATION_VENDOR_NAME = "EVBox";
    ...
    public VendorNameVariableAccessor(Station station, StationStore stationStore) {
    ...
    public List<ReportData> generateReportData(String componentName) {
        VariableCharacteristics variableCharacteristics = new VariableCharacteristics()
                .withDataType(STRING)
                .withMaxLimit(new BigDecimal(50))
                .withSupportsMonitoring(false);
        VariableAttribute variableAttribute = new VariableAttribute()
                .withValue(new CiString.CiString2500(STATION_VENDOR_NAME))
    ...
    private GetVariableResult getActualValue(AttributePath attributePath) {
        return new GetVariableResult()
                ...
                .withAttributeValue(new CiString.CiString2500(STATION_VENDOR_NAME));
    }
}
