...
public class TxEndedMeasurandsVariableAccessor extends VariableAccessor {
    public static final String NAME = "TxEndedMeasurands";
    public static final String TRANSACTION_ENDED_MEASURANDS = "Energy.Active.Import.Register";
    ...
    public TxEndedMeasurandsVariableAccessor(Station station, StationStore stationStore) {
    ...
    public List<ReportData> generateReportData(String componentName) {
        ...
        VariableAttribute variableAttribute = new VariableAttribute()
                .withValue(new CiString.CiString2500(TRANSACTION_ENDED_MEASURANDS))
                .withPersistent(true)
    ...
    private GetVariableResult getActualValue(AttributePath attributePath) {
        return new GetVariableResult()
                ...
                .withAttributeValue(new CiString.CiString2500(TRANSACTION_ENDED_MEASURANDS));
    }
}
