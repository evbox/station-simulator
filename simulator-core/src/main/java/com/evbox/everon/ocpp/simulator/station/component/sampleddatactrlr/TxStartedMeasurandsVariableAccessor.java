...
public class TxStartedMeasurandsVariableAccessor extends VariableAccessor {
    public static final String NAME = "TxStartedMeasurands";
    public static final String TRANSACTION_STARTED_MEASURANDS = "Energy.Active.Import.Register";
    ...
    private final Map<AttributeType, SetVariableValidator> variableValidators = ImmutableMap.<AttributeType, SetVariableValidator>builder()
            ...
            .build();
    public TxStartedMeasurandsVariableAccessor(Station station, StationStore stationStore) {
    ...
    public List<ReportData> generateReportData(String componentName) {
        ...
        VariableAttribute variableAttribute = new VariableAttribute()
                .withValue(new CiString.CiString2500(TRANSACTION_STARTED_MEASURANDS))
                .withPersistent(true)
    ...
    private GetVariableResult getActualValue(AttributePath attributePath) {
        return new GetVariableResult()
                ...
                .withAttributeValue(new CiString.CiString2500(TRANSACTION_STARTED_MEASURANDS));
    }
}
