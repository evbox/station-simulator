...
public class WebSocketMessageRouter {
    ...
    public WebSocketMessageRouter(WebSocketClient webSocketClient) {
        this.messageHandlers = ImmutableMap.<AbstractWebSocketClientInboxMessage.Type, MessageHandler>builder()
     ...
     */
    public void route(AbstractWebSocketClientInboxMessage message) {
