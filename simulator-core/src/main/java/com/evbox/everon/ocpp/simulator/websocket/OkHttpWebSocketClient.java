...
public class OkHttpWebSocketClient {
    ...
    public void connect(String url) {
        ...
        if (nonNull(stationConfiguration.getComponentsConfiguration().getSecurity().getBasicAuthPassword())) {
    ...
    private byte[] prepareAuthPassword() throws DecoderException {
        ...
        byte[] decodedPassword = Hex.decodeHex(stationConfiguration.getComponentsConfiguration().getSecurity().getBasicAuthPassword());
