...
public class ServerMessageHandlerTest {
    ...
    @BeforeEach
    void setUp() {
        serverMessageHandler = new ServerMessageHandler(stationMock, stationPersistenceLayerMock, stationMessageSenderMock, null, STATION_ID, subscriptionRegistryMock);
