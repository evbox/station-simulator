...
class SerialNumberVariableAccessorTest {
    ...
    static Stream<Arguments> setVariableDatumProvider() {
        return Stream.of(
                arguments(ChargingStationComponent.NAME, SerialNumberVariableAccessor.NAME, SetVariableDatum.AttributeType.ACTUAL, "some_value", SetVariableResult.AttributeStatus.REJECTED)
        );
    }

    static Stream<Arguments> getVariableDatumProvider() {
        return Stream.of(
                arguments(ChargingStationComponent.NAME, SerialNumberVariableAccessor.NAME, GetVariableDatum.AttributeType.ACTUAL, GetVariableResult.AttributeStatus.ACCEPTED, StationHardwareData.SERIAL_NUMBER),
                arguments(ChargingStationComponent.NAME, SerialNumberVariableAccessor.NAME, GetVariableDatum.AttributeType.MAX_SET, GetVariableResult.AttributeStatus.NOT_SUPPORTED_ATTRIBUTE_TYPE, null)
        );
    }
