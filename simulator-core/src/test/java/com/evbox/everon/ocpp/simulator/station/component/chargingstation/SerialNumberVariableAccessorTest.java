...
class SerialNumberVariableAccessorTest {
    ...
    void setup() {
        ...
        variableAccessor = new SerialNumberVariableAccessor(null, stationStore);
    }

    static Stream<Arguments> setVariableDatumProvider() {
        return Stream.of(
                arguments(ACTUAL_ATTRIBUTE, StationHardwareData.SERIAL_NUMBER, SetVariableStatus.REJECTED),
                arguments(MAX_SET_ATTRIBUTE, StationHardwareData.SERIAL_NUMBER, SetVariableStatus.NOT_SUPPORTED_ATTRIBUTE_TYPE),
                arguments(MIN_SET_ATTRIBUTE, StationHardwareData.SERIAL_NUMBER, SetVariableStatus.NOT_SUPPORTED_ATTRIBUTE_TYPE),
                arguments(TARGET_ATTRIBUTE, StationHardwareData.SERIAL_NUMBER, SetVariableStatus.NOT_SUPPORTED_ATTRIBUTE_TYPE)
        );
    }

    static Stream<Arguments> getVariableDatumProvider() {
        return Stream.of(
                arguments(ACTUAL_ATTRIBUTE, GetVariableStatus.ACCEPTED, StationHardwareData.SERIAL_NUMBER),
