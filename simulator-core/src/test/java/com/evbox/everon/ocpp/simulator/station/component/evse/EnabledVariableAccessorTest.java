...
class EnabledVariableAccessorTest {
    ...
    static Stream<Arguments> setVariableDatumProvider() {
        return Stream.of(
                arguments(EVSEComponent.NAME, EnabledVariableAccessor.NAME, SetVariableDatum.AttributeType.ACTUAL, EnabledVariableAccessor.EVSE_ENABLED_STATUS, SetVariableResult.AttributeStatus.REJECTED)
        );
    }

    static Stream<Arguments> getVariableDatumProvider() {
        return Stream.of(
                arguments(EVSEComponent.NAME, EnabledVariableAccessor.NAME, EVSE_ID, GetVariableDatum.AttributeType.ACTUAL, GetVariableResult.AttributeStatus.ACCEPTED, EnabledVariableAccessor.EVSE_ENABLED_STATUS),
                arguments(EVSEComponent.NAME, EnabledVariableAccessor.NAME, EVSE_ID, GetVariableDatum.AttributeType.MAX_SET, GetVariableResult.AttributeStatus.NOT_SUPPORTED_ATTRIBUTE_TYPE, null),
