...
public class StationConstants {
    ...
    public static final String BASIC_AUTH_PASSWORD = "0123456789abcdef";
    ...
    public static final String DEFAULT_TRANSACTION_ID = "T_00000001";
    ...
    public static final String DEFAULT_MODEL = "Livo";
    public static final String DEFAULT_FIRMWARE_VERSION = "v5.14.1;1.1.1";
