...
class ModelVariableAccessorTest {
    ...
    static Stream<Arguments> setVariableDatumProvider() {
        return Stream.of(
                arguments(ChargingStationComponent.NAME, ModelVariableAccessor.NAME, SetVariableDatum.AttributeType.ACTUAL, "some_value", SetVariableResult.AttributeStatus.REJECTED)
        );
    }

    static Stream<Arguments> getVariableDatumProvider() {
        return Stream.of(
                arguments(ChargingStationComponent.NAME, ModelVariableAccessor.NAME, GetVariableDatum.AttributeType.ACTUAL, GetVariableResult.AttributeStatus.ACCEPTED, StationHardwareData.MODEL),
                arguments(ChargingStationComponent.NAME, ModelVariableAccessor.NAME, GetVariableDatum.AttributeType.MAX_SET, GetVariableResult.AttributeStatus.NOT_SUPPORTED_ATTRIBUTE_TYPE, null)
        );
    }
