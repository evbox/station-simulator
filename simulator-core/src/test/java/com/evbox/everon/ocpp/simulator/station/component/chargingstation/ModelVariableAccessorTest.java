...
class ModelVariableAccessorTest {
    ...
    void setup() {
        ...
        variableAccessor = new ModelVariableAccessor(null, stationStore);
    }

    static Stream<Arguments> setVariableDatumProvider() {
        return Stream.of(
                arguments(ACTUAL_ATTRIBUTE, "some_value", SetVariableStatus.REJECTED),
                arguments(MAX_SET_ATTRIBUTE, "some_value", SetVariableStatus.NOT_SUPPORTED_ATTRIBUTE_TYPE),
                arguments(MIN_SET_ATTRIBUTE, "some_value", SetVariableStatus.NOT_SUPPORTED_ATTRIBUTE_TYPE),
                arguments(TARGET_ATTRIBUTE, "some_value", SetVariableStatus.NOT_SUPPORTED_ATTRIBUTE_TYPE)
        );
    }

    static Stream<Arguments> getVariableDatumProvider() {
        return Stream.of(
                arguments(ACTUAL_ATTRIBUTE, GetVariableStatus.ACCEPTED, StationHardwareData.MODEL),
